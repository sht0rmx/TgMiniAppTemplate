  ...
  <div
    ...
    <div class="mt-3">
      <div class="flex flex-col gap-1 mb-2 ml-2">
        <div class="flex flex-row items-center justify-between is-drawer-close:justify-center is-drawer-close:mb-5">
          <div class="flex items-center min-w-0" @click="$router.push('/')">
        ...
        <p class="text-xs ml-2 mr-2 is-drawer-close:hidden wrap-break-word overflow-hidden text-ellipsis">
          {{ $t('components.sidebar.hint') }}
        </p>
      </div>

      <ul class="mx-0 is-drawer-open:mx-4 p-0">
        <li v-for="i in nav_items" :key="i.to" @click="$router.push(i.to)" class="flex justify-center"
          ...
          <button
            ...
            <span class="is-drawer-close:hidden truncate whitespace-nowrap"
    ...
    <div class="w-full overflow-hidden">
      <div v-if="authStatus"
        ...
        <div class="avatar placeholder shrink-0">
          <div class="w-12 rounded-full ring ring-base-300 ring-offset-base-100 ring-offset-2">
            ...
            <div v-else class="bg-accent text-accent-content w-full h-full flex items-center justify-center">
      ...
      <div v-else
        ...
        <div class="text-center is-drawer-close:hidden mt-2 w-full">
          ...
          <button class="btn btn-soft btn-warning btn-sm w-full mt-2" @click="$router.push('/login')">
